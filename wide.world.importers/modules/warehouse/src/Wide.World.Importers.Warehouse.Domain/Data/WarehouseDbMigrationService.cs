...
{
    public class WarehouseDbMigrationService : ITransientDependency
    {
        public ILogger<WarehouseDbMigrationService> Logger { get; set; }

        private readonly IDataSeeder _dataSeeder;
        private readonly IEnumerable<IWarehouseDbSchemaMigrator> _dbSchemaMigrators;
        private readonly ITenantRepository _tenantRepository;
        private readonly ICurrentTenant _currentTenant;

        public WarehouseDbMigrationService(
            IDataSeeder dataSeeder,
            IEnumerable<IWarehouseDbSchemaMigrator> dbSchemaMigrators,
            ...
            ICurrentTenant currentTenant)
        {
            ...
            Logger = NullLogger<WarehouseDbMigrationService>.Instance;
        }
