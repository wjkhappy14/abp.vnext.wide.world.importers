...
{
    public class ImportersDbMigrationService : ITransientDependency
    {
        public ILogger<ImportersDbMigrationService> Logger { get; set; }

        private readonly IDataSeeder _dataSeeder;
        private readonly IEnumerable<IImportersDbSchemaMigrator> _dbSchemaMigrators;
        private readonly ITenantRepository _tenantRepository;
        private readonly ICurrentTenant _currentTenant;

        public ImportersDbMigrationService(
            IDataSeeder dataSeeder,
            IEnumerable<IImportersDbSchemaMigrator> dbSchemaMigrators,
            ...
            ICurrentTenant currentTenant)
        {
            ...
            Logger = NullLogger<ImportersDbMigrationService>.Instance;
        }
